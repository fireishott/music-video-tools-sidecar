...
2. Download the [scripts_init.bash](https://github.com/fireishott/arr-scripts_Video/blob/main/lidarr/scripts_init.bash) and place it into `/custom-cont-init.d`
